...
export default function PosterCard({ vod }: { vod: VOD }) {
  return (
    <Link href={`/series/${vod.series_id}`} className="group shrink-0 w-60">
      <div className={`w-60 h-[360px] rounded-lg bg-gradient-to-b ${vod.poster_url} flex items-end p-3 overflow-hidden
